...
import com.zsCat.common.lucene.util.DocumentUtil;
import com.zsCat.common.lucene.util.IKAnalyzer5x;
import com.zsCat.common.lucene.util.QueryUtil;
...
public class LuceneDao {
	...
	public Directory getDirectory() throws IOException {
		if(directory == null){
			this.setIndexDer("D:\\hulu\\webappchat\\zscat\\luence");
			File indexRepositoryFile = new File(this.indexDer);
			System.out.println("luence-path:"+indexRepositoryFile.getAbsolutePath());
    ...
    public PageUtils page(Integer pageNumber, Integer pageSize,String keyword){
		...
		try {
			...
			pageQuery = new PageUtils(searchResults,topDocs.totalHits);
