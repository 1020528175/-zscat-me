...
public class IndexController{
    ...
    public String index(Model model) {
        try {
           ...
           for (TFloorDO floorDO:floorList){
            ...
            List<ArticleDO> tArticleList1 = articleService.list(params);
            model.addAttribute("tArticleList1", tArticleList1);
        }catch (Exception e){
            e.printStackTrace();
        }
        return PREFIX + "index";
    ...
    public String goodsDetail(@PathVariable Long id, Model model, HttpServletRequest request, HttpServletResponse resp) {
        ...
        params.put("limit", 4);
        params.put("iscom","1");
        model.addAttribute("allcommList", tGoodsService.list1(params));
        params = new Query(params1);
        params.put("sort","replyhit");
        params.put("order","desc");
        params.put("limit", 8);
        ...
        model.addAttribute("orderGoodsList", gs);
